...
My goal is to continue developing practical cybersecurity skills and build a portfolio that shows employers my ability to analyze systems, document findings clearly, and approach security work responsibly.
...
- Linux system logs and `journalctl`
- Log observation and analysis
- Cybersecurity documentation
- Evidence collection and reporting
- GitHub and GitHub Pages
- Basic Python experience
- Professional communication
- Ethical scope awareness
...
- GitHub: [https://github.com/GitWitIt-CM](https://github.com/GitWitIt-CM)
